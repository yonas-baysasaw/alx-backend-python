...
SECRET_KEY = 'django-insecure-jd!%vh9h!y3rvlpu)bcz683a$22e_%-kc^^s_ot^w@#&4uv&cn'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=2),   # default was 5 minutes
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),   # default was 1 day
